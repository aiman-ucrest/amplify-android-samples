...
import com.amplifyframework.samples.core.NewItemAdapter
import com.amplifyframework.samples.gettingstarted.databinding.TodoItemBinding
import java.io.Serializable
import java.util.*
import java.util.concurrent.TimeUnit

class NewTodoItemAdapter(context: Context, private val listener: OnItemClickListener? = null) :
    NewItemAdapter<Todo>(context), Serializable {
